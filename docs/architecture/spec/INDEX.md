...
| [attachments.md](mobile/attachments.md) | 图片与文本文件附件输入（P0）：后端 attachment store、REST API、provider 能力、context projection、Android Composer 附件按钮、PendingAttachment 状态机、ContentBlock 扩展、生命周期 |
