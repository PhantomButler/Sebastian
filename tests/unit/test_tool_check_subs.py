...
async def test_check_sub_agents_as_leader():
    ...
    mock_state.index_store = AsyncMock()
    mock_state.index_store.list_all = AsyncMock(return_value=[
        {"id": "s1", "agent_type": "code", "depth": 3, "parent_session_id": "leader_session", "status": "active", "title": "子任务A"},
        {"id": "s2", "agent_type": "code", "depth": 3, "parent_session_id": "leader_session", "status": "completed", "title": "子任务B"},
        # Different agent_type — should be excluded
        {"id": "s3", "agent_type": "stock", "depth": 3, "parent_session_id": "leader_session", "status": "active", "title": "股票任务"},
        # Depth 2 — should be excluded
        {"id": "s4", "agent_type": "code", "depth": 2, "parent_session_id": None, "status": "active", "title": "组长任务"},
        # Different parent — should be excluded (another leader's child)
        {"id": "s5", "agent_type": "code", "depth": 3, "parent_session_id": "other_leader", "status": "active", "title": "他人子任务"},
    ])
